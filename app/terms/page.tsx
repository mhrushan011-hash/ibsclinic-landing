  ...
  return (
    <main className="bg-linen">
      <article className="container-page mx-auto max-w-prose py-16 leading-relaxed">
        <h1 className="text-h2 text-sage-dark">Terms of Service</h1>
        <p className="mt-2 text-sm text-slate/60">
          Placeholder draft — review by legal counsel before publishing.
        </p>

        <h2 className="mt-10 font-heading text-h3 text-sage-dark">Acceptance of terms</h2>
        <p className="mt-3">
          By using consultation.ibsclinic.com you agree to these terms. If you do not agree,
          please do not use the service.
        </p>

        <h2 className="mt-8 font-heading text-h3 text-sage-dark">Service scope</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-8 font-heading text-h3 text-sage-dark">No guarantees</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-8 font-heading text-h3 text-sage-dark">Refund &amp; cancellation</h2>
        <p className="mt-3">
          See the Refund &amp; Cancellation policy [link].
        </p>

        <h2 className="mt-8 font-heading text-h3 text-sage-dark">Limitation of liability</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-8 font-heading text-h3 text-sage-dark">Governing law</h2>
        <p className="mt-3">
