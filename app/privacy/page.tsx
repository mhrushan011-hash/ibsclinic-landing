  ...
  return (
    <main className="bg-white">
      <article className="container-page mx-auto max-w-prose py-16 leading-relaxed">
        <h1 className="text-h2 text-charcoal">Privacy Policy</h1>
        ...
        <h2 className="mt-10 font-heading text-h3 text-charcoal">What we collect</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-8 font-heading text-h3 text-charcoal">Why we collect it</h2>
        <p className="mt-3">
        ...
        <h2 className="mt-8 font-heading text-h3 text-charcoal">Your rights</h2>
        <p className="mt-3">
          Access, correction, erasure, and withdrawal of consent at any time. Contact our
          Grievance Officer to exercise these rights.
        </p>

        <h2 className="mt-8 font-heading text-h3 text-charcoal">Grievance Officer</h2>
        <p className="mt-3">
