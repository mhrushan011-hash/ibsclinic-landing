...
export const post: BlogPost = {
  "slug": "ibs-symptoms",
  "title": "IBS Symptoms: Complete Guide to Recognition, Management, and When to Seek Care",
  "metaTitle": "IBS Symptoms: Recognition, Management & When to Seek Care | IBS Clinic",
  "metaDescription": "IBS symptoms can be confusing, frustrating, and disruptive — but early recognition and personalized care make a big difference. Learn the signs and when to seek care.",
  "excerpt": "A complete guide to IBS symptoms — abdominal pain, bloating, and bowel changes — covering differences in women vs men, red flags, and when to seek care.",
  "authorSlug": "kamal",
  "category": "Symptoms",
